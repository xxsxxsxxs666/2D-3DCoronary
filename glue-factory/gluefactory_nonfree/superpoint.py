...
class SuperPoint(BaseModel):
    ...
    local_checkpoint_path = "/home/xiaosong_xiong/Intern_project/CTA2DSA/lightglue/LightGlue/pretrained_weight/superpoint_v1.pth"
    ...
    def _init(self, conf):
        ...
        if conf.weights is not None:
            self.load_state_dict(torch.load(conf.weights), strict=False)
        elif self.local_checkpoint_path:
            self.load_state_dict(torch.load(self.local_checkpoint_path), strict=False)
        else:
