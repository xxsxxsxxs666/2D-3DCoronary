...
def plot_images(imgs, titles=None, cmaps="gray", dpi=100, pad=0.5, adaptive=True, file_name=None):
...
def plot_matches(kpts0, kpts1, color=None, lw=1.5, ps=4, a=1.0, labels=None, axes=None, file_name=None, dt=None):
